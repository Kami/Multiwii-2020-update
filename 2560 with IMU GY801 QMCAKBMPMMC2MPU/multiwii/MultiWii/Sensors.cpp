...
// NOTE (Tomaz): Correct address is 0x1e!
#define LSM303DLHCMA 0x1e
  void Mag_init() {
...
#define LSM303DLHCAA  0x32 // I2C adress: 0x32 (8bit)
void ACC_init () {
  i2c_writeReg(LSM303DLHCAA,0x20,0x47);  // CTRL_REG1_A   0100 0111  Pwr on, 50Hz
